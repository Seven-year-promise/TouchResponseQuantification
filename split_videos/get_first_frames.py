...
parser.add_argument('--video_path', type=str, default = './first_frames/20210723-6well-dataset-no_ring/10/',
                   help='sum the integers (default: find the max)')
parser.add_argument('--save_path', type=str, default = './first_frames/1/20210723-6well-dataset-no_ring/10/',
                   help='sum the integers (default: find the max)')
